...
begin
  ...
  insert into vendors (id, slug, name, category, tagline, story, town, practices, market_days, image_url, email, status, featured) values
    ...
    ('a0000000-0000-4000-8000-000000000025', 'hazel-dell-tomatoes', 'Hazel Dell Tomatoes', 'Produce',
     ...
     'Monroe, OR', '{"No-spray","Heirloom"}', '{"Saturday"}',
     'https://images.unsplash.com/photo-1692737003338-f2071356a62b?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000026', 'three-sisters-kombucha', 'Three Sisters Kombucha', 'Beverages',
     ...
     'https://images.unsplash.com/photo-1642423453295-1e21cbc95967?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000027', 'tangent-tofu', 'Tangent Tofu', 'Prepared Foods',
     ...
     'https://images.unsplash.com/photo-1767324672583-8818531f650a?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000028', 'calapooia-pasta', 'Calapooia Pasta', 'Prepared Foods',
     ...
     'https://images.unsplash.com/photo-1605311525808-ea0daef137b7?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000029', 'marys-river-chocolates', 'Mary''s River Chocolates', 'Prepared Foods',
     ...
     'https://images.unsplash.com/photo-1623660053975-cf75a8be0908?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000030', 'sundance-salsa', 'Sundance Salsa Co.', 'Honey & Preserves',
     ...
     'https://images.unsplash.com/photo-1700619773778-f02b45ca0616?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000031', 'willow-creek-lamb', 'Willow Creek Lamb', 'Meat & Eggs',
     ...
     'https://images.unsplash.com/photo-1772215842204-3e5838af499c?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000032', 'calico-hen-farm', 'Calico Hen Farm', 'Meat & Eggs',
     ...
     'https://images.unsplash.com/photo-1509479100390-f83a8349e79c?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000033', 'bramble-and-bloom', 'Bramble & Bloom', 'Flowers',
     ...
     'https://images.unsplash.com/photo-1771657570894-36f1d5cf5da3?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000034', 'filbert-hollow-nursery', 'Filbert Hollow Nursery', 'Herbs & Plants',
     ...
     'https://images.unsplash.com/photo-1585416847683-64c505faf145?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000035', 'steeping-room-tea', 'Steeping Room Tea', 'Coffee & Tea',
     ...
     'https://images.unsplash.com/photo-1558160074-4d7d8bdf4256?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000036', 'corvallis-crepe-co', 'Corvallis Crepe Co.', 'Prepared Foods',
     ...
     'https://images.unsplash.com/photo-1583338917496-7ea264c374ce?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000037', 'honeycrisp-hill-orchard', 'Honeycrisp Hill Orchard', 'Orchard & Fruit',
     ...
     'Lebanon, OR', '{"IPM","Family orchard"}', '{"Saturday"}',
     'https://images.unsplash.com/photo-1635778528589-b5df9e10d7cd?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000038', 'edge-and-anvil-sharpening', 'Edge & Anvil Sharpening', 'Services',
     ...
     'https://images.unsplash.com/photo-1509460364839-ef5b594e0ee8?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000039', 'riverside-cyclery', 'Riverside Cyclery', 'Services',
     ...
     'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000040', 'stillwater-chair-massage', 'Stillwater Chair Massage', 'Services',
     ...
     'https://images.unsplash.com/photo-1601881557868-34ad67bd4633?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000041', 'kestrel-studio-prints', 'Kestrel Studio Prints', 'Art & Crafts',
     ...
     'https://images.unsplash.com/photo-1537811465496-6c38a51d2d81?auto=format&fit=crop&w=900&q=70',
    ...
    ('a0000000-0000-4000-8000-000000000042', 'cascade-tree-farm', 'Cascade Tree Farm', 'Trees & Nursery',
     ...
     'https://images.unsplash.com/photo-1727120279660-5c28b8461609?auto=format&fit=crop&w=900&q=70',
  ...
  insert into vendor_schedule (vendor_id, market_date_id, status, stalls, note) values
    ...
    ('a0000000-0000-4000-8000-000000000011', '33330000-0000-4000-8000-000000000012', 'confirmed', '{A3}', null),
    ('a0000000-0000-4000-8000-000000000005', '33330000-0000-4000-8000-000000000012', 'confirmed', '{A4}', null),
    ('a0000000-0000-4000-8000-000000000006', '33330000-0000-4000-8000-000000000012', 'confirmed', '{A5}', null),
    ('a0000000-0000-4000-8000-000000000015', '33330000-0000-4000-8000-000000000012', 'confirmed', '{A6}', null),
    ('a0000000-0000-4000-8000-000000000016', '33330000-0000-4000-8000-000000000012', 'confirmed', '{A7}', null),
    ('a0000000-0000-4000-8000-000000000014', '33330000-0000-4000-8000-000000000012', 'confirmed', '{A8}', null),
    ('a0000000-0000-4000-8000-000000000020', '33330000-0000-4000-8000-000000000012', 'confirmed', '{B1}', null),
    ('a0000000-0000-4000-8000-000000000012', '33330000-0000-4000-8000-000000000012', 'confirmed', '{B2}', null),
    ('a0000000-0000-4000-8000-000000000029', '33330000-0000-4000-8000-000000000012', 'confirmed', '{B3}', null),
    ('a0000000-0000-4000-8000-000000000019', '33330000-0000-4000-8000-000000000012', 'confirmed', '{B4}', null),
    ('a0000000-0000-4000-8000-000000000035', '33330000-0000-4000-8000-000000000012', 'confirmed', '{B5}', null),
    ('a0000000-0000-4000-8000-000000000038', '33330000-0000-4000-8000-000000000012', 'confirmed', '{C1}', null),
    ('a0000000-0000-4000-8000-000000000001', '33330000-0000-4000-8000-000000000012', 'confirmed', '{B6}', null),  -- Fern Hollow = vendor@ demo persona
    ('a0000000-0000-4000-8000-000000000009', '33330000-0000-4000-8000-000000000013', 'confirmed', '{A1}', null),
    ('a0000000-0000-4000-8000-000000000002', '33330000-0000-4000-8000-000000000013', 'confirmed', '{A2}', null),
    ('a0000000-0000-4000-8000-000000000005', '33330000-0000-4000-8000-000000000013', 'confirmed', '{A4}', null),
    ('a0000000-0000-4000-8000-000000000006', '33330000-0000-4000-8000-000000000013', 'confirmed', '{A5}', null),
  ...
  update tenants set
    logo_url  = 'https://images.unsplash.com/photo-1692737003338-f2071356a62b?auto=format&fit=crop&w=100&h=100&q=80',
    banner_url = 'https://images.unsplash.com/photo-1638132704795-6bb223151bf7?auto=format&fit=crop&w=1800&q=80'
